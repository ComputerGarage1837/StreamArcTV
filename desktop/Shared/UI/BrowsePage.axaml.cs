...
public partial class BrowsePage : AppPage, EpgGridView.IListener
{
    ...
    public BrowsePage(Service service, ContentKind? kind, string? category = null, bool search = false)
    {
        ...
        {
            PanelEpg.IsVisible = false;
            EpgGrid.IsVisible = false;
        }
        ...
        {
            ApplyCategoryLayout();
            if (_openSearch) Dispatcher.UIThread.Post(() => InputSearch.Focus(), DispatcherPriority.Input);
        };
        LoadCategories();
    }
    ...
    private void StartPreview(Data.Stream stream)
    {
        ...
        try
        {
            ...
            PreviewPlayer.IsVisible = true;
            ImgPanelLogo.IsVisible = false;
    ...
    private void ApplyCategoryLayout()
    {
        ...
        TxtPanelDesc.IsVisible = !compact;
        TxtPanelUpcoming.IsVisible = !compact;
        ...
        else
        {
            ...
            BodyGrid.ColumnDefinitions[0].Width = new GridLength(IsLive ? 140 : 220);
        }
        RenderCategories();
    }
    ...
    private void PlaceTabs(bool compact)
    {
        ...
        Tabs.IsVisible = showTabs && !compact;
        TabsRow.IsVisible = showTabs && compact;
        // The chip row already shows the category; the top-bar label is dropped when narrow.
        TxtCategory.IsVisible = !compact;
    }
    ...
    private void RenderCategories()
    {
        ...
        foreach (var c in _categories)
        {
            ...
            {
                Classes = { _compact ? "chip" : "category" },
                Selected = cat.Id == _selectedId,
                Content = new TextBlock
                {
                    Text = cat.Name ?? "—", FontSize = _compact ? 13 : 14, TextTrimming = TextTrimming.CharacterEllipsis,
                    FontWeight = _compact ? FontWeight.SemiBold : FontWeight.Normal, MaxWidth = _compact ? 200 : double.PositiveInfinity
                }
            };
    ...
    private void ApplyFilter()
    {
        ...
        if (IsLive)
        {
            ...
            if (list.Count > 0 && !InputSearch.IsFocused && Ui.Focused is not Control { IsEffectivelyVisible: true }) EpgGrid.Focus();
        ...
        TxtEmpty.IsVisible = list.Count == 0;
    }
    ...
    {
        var w = Math.Max(300, Bounds.Width - (_compact ? 0 : (IsLive ? 140 : 220)) - 40);
    ...
    private void HideGuideProgress() => GuideLoading.IsVisible = false;
    ...
    private void SetLoading(bool loading)
    {
        ...
        if (loading) TxtEmpty.IsVisible = false;
    }
