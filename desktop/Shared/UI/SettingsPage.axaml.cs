...
public partial class SettingsPage : AppPage
{
    ...
    public SettingsPage()
    {
        ...
        SwitchAutoUpdate.Toggled += v => _prefs.AutoCheckUpdates = v;
        ...
        SwitchAutoPlayNext.Toggled += v => _prefs.AutoPlayNext = v;
        SwitchWifiOnly.IsChecked = _prefs.DownloadsWifiOnly;
        SwitchWifiOnly.Toggled += v => _prefs.DownloadsWifiOnly = v;
        SwitchDeleteWatched.IsChecked = _prefs.DeleteAfterWatched;
        SwitchDeleteWatched.Toggled += v => _prefs.DeleteAfterWatched = v;
    ...
    private void RenderSkipped()
    {
        ...
        BtnClearSkipped.IsVisible = v != null;
    }
